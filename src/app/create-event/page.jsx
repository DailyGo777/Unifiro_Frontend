        ...
        <div className="flex h-full min-h-[60vh] flex-col items-center justify-center p-6 relative animate-fade-in-up">
            ...
            <div className="flex flex-col items-center text-center max-w-2xl mx-auto space-y-8">
                ...
                <Link href="/create-event/templates">
                    <button
                        className="group relative flex flex-col items-center justify-center w-48 h-40 rounded-3xl bg-gradient-to-br from-[#20B3BC] via-[#13C998] to-[#13C998] shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer"
